...
using WebApiOwinAutofac.Providers;
using WebApiOwinAutofac.Results;

namespace WebApiOwinAutofac.Controllers
{
    [Authorize]
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(ApplicationUserManager _userManager, IAuthenticationManager authenticationManager, ISecureDataFormat<AuthenticationTicket> accessTokenFormat)
        {
